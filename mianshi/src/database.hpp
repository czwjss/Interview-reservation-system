...
class DataBaseSvr
{
    public:
        ...
        bool QueryOneStuInfo(std::string user_id, Json::Value* result)
        {
            ...
            (*result)["stu_choice_score"] = JUDGEVALUE(row[2]);
            (*result)["stu_program_score"] = JUDGEVALUE(row[3]);
            (*result)["stu_total_score"] = JUDGEVALUE(row[4]);
            (*result)["stu_speculative_score"] = JUDGEVALUE(row[5]);
            (*result)["stu_code_score"] = JUDGEVALUE(row[6]);
            (*result)["stu_think_score"] = JUDGEVALUE(row[7]);
            (*result)["stu_expression_score"] = JUDGEVALUE(row[8]);
            (*result)["stu_interview_score"] = JUDGEVALUE(row[9]);
            (*result)["stu_interview_techer"] = JUDGEVALUE(row[10]);
            (*result)["stu_techer_suggest"] = JUDGEVALUE(row[11]);
            (*result)["stu_interview_time"] = JUDGEVALUE(row[12]);
